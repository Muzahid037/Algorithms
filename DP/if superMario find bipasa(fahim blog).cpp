...
void solve()
{
    ...
    check(0,0); ///let M/1 always in (0,0) position
    if(found==0) cout<<"did not find!"<<endl;
...
///.=3
///X=4
///we have to go from M-to-B / 1-to-2
///problem description link: https://sites.google.com/site/smilitude/recursion_and_dp
